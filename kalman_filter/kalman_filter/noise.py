...
class Noise(Node):
    ...
    def Noise(self,msg:Odometry):
        ...
        self.nosied_Reading.twist.twist.linear.x=groundTruthReading.twist.twist.linear.x
        self.nosied_Reading.twist.twist.linear.y=groundTruthReading.twist.twist.linear.y
